...
export async function sincronizarCambios({ alTerminar = null } = {}) {
  ...
  try {
    let q = supabase
      ...
      // Solo los productos propios. Los "a pedido" son casi 2800 y cambian
      // de precio seguido: sincronizarlos gastaría datos del cliente sin
      // sentido, porque igual hay que consultarlos antes de encargarlos.
